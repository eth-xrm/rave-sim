...
#![allow(unused)]
//! Dealing with .npy file headers
//!
//! Taken from [npy-rs](https://github.com/potocpav/npy-rs/blob/87eefdee2d21580bb0d90050fdadfc99820bee3e/src/header.rs)
//!
//! SPDX-License-Identifier: MIT
//!
//! Copyright: Pavel Potoček
